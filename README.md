...
I implemented a Kalman Filter for this project and achieved the following results:

| RMSE | Both sensors | Lidar only | Radar only |
| ---  |   ----       | ---------- | ---------- |
|  px  |   0.097      |    0.145   |    0.225   |
|  py  |   0.086      |    0.115   |    0.346   |
